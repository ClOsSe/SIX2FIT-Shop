<template>
  <q-page>
    <TableProduct :productsitem="productsitem" />
    <div class="flex">
    <q-btn size="25" flat    icon="location_on"/>
    <h5>آدرس</h5>
    </div>
            <AddressForm  :userAddress="noneEditAbleAddress" />
...
<script>
import TableProduct from "../../components/table_product/TableProduct.vue";
import AddressForm from "../../components/cart/address/AddressForm.vue";
export default {
  components: {
    TableProduct,
    AddressForm,
